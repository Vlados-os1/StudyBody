...
Revision ID: 5e0521b28078
Revises: 
Create Date: 2025-08-18 14:08:57.667792
...
def upgrade() -> None:
    ...
    sa.Column('expire', sa.TIMESTAMP(timezone=True), nullable=False),
    ...
    sa.Column('department', sa.Enum('iu', 'mt', 'ibm', 'sm', 'fn', 'bmt', 'rk', 'rl', 'energy', 'ur', 'sgn', 'ling', name='userdepartment'), nullable=True),
